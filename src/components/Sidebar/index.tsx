...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div style={{ marginBottom: 0, paddingBottom: 0 }} className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <h1 style={{ fontWeight: 500, fontSize: 18 }}>ISYS2110 - Analysis and Design of Web Info Systems</h1>
        </NavLink>
